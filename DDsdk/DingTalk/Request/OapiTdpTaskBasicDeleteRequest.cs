...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.tdp.task.basic.delete
    /// </summary>
    public class OapiTdpTaskBasicDeleteRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiTdpTaskBasicDeleteResponse>
    {
        /// <summary>
        /// 微应用agentId
        /// </summary>
