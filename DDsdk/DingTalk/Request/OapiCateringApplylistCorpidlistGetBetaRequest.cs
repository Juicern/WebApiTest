...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.catering.applylist.corpidlist.get.beta
    /// </summary>
    public class OapiCateringApplylistCorpidlistGetBetaRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiCateringApplylistCorpidlistGetBetaResponse>
    {
        /// <summary>
        /// 店铺id列表
        /// </summary>
