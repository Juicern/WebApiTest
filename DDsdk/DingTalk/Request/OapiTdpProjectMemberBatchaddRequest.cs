...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.tdp.project.member.batchadd
    /// </summary>
    public class OapiTdpProjectMemberBatchaddRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiTdpProjectMemberBatchaddResponse>
    {
        /// <summary>
        /// 微应用agentId
        /// </summary>
