...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.catering.coop.deal
    /// </summary>
    public class OapiCateringCoopDealRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiCateringCoopDealResponse>
    {
        /// <summary>
