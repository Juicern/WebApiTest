...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.catering.allowance.prededuct
    /// </summary>
    public class OapiCateringAllowancePredeductRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiCateringAllowancePredeductResponse>
    {
        /// <summary>
        /// 抵扣部分金额的超时时间（毫秒）
        /// </summary>
