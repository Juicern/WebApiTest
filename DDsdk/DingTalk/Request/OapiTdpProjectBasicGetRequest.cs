...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.tdp.project.basic.get
    /// </summary>
    public class OapiTdpProjectBasicGetRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiTdpProjectBasicGetResponse>
    {
        /// <summary>
        /// 微应用agentId
        /// </summary>
