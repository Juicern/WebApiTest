...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.catering.allowance.prededuct.beta
    /// </summary>
    public class OapiCateringAllowancePredeductBetaRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiCateringAllowancePredeductBetaResponse>
    {
        /// <summary>
        /// 抵扣部分金额的超时时间（毫秒）
        /// </summary>
