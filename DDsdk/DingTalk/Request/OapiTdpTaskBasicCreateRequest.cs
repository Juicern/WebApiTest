...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.tdp.task.basic.create
    /// </summary>
    public class OapiTdpTaskBasicCreateRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiTdpTaskBasicCreateResponse>
    {
        /// <summary>
        /// 微应用agentId
        /// </summary>
