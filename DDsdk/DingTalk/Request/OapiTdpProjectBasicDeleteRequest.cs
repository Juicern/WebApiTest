...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.tdp.project.basic.delete
    /// </summary>
    public class OapiTdpProjectBasicDeleteRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiTdpProjectBasicDeleteResponse>
    {
        /// <summary>
        /// 微应用agentId
        /// </summary>
