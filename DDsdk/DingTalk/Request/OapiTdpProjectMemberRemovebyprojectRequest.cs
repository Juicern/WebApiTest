...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.tdp.project.member.removebyproject
    /// </summary>
    public class OapiTdpProjectMemberRemovebyprojectRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiTdpProjectMemberRemovebyprojectResponse>
    {
        /// <summary>
        /// 微应用agentId
        /// </summary>
